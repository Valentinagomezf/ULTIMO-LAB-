...
Luego se realiza la gráfica del diagrama, donde cada punto permite visualizar el comportamiento de los intervalos R-R entre latidos consecutivos. También se agrega una línea diagonal como referencia, indicando el caso ideal en el que todos los intervalos serían iguales. Finalmente, la función se aplica a los dos segmentos de la señal ECG para comparar el comportamiento de la variabilidad cardíaca en cada condición experimental.
...
<img width="1280" height="874" alt="WhatsApp Image 2026-05-21 at 10 58 47 PM" src="https://github.com/user-attachments/assets/87fc21ff-a647-45d4-b492-a16c5440d1b5" />
...
## Análisis 
Para los diagramas de Poincaré correspondientes al segmento 1 (reposo), se observa que los intervalos R-R presentan una distribución relativamente compacta alrededor de la línea de identidad, indicando que la mayoría de los latidos consecutivos mantienen una duración similar. Esto refleja un comportamiento cardíaco más estable y controlado durante esta condición experimental. Además, la nube de puntos presenta una dispersión moderada y una elipse con dimensiones similares en ambos ejes, concordando con los valores obtenidos de SD1 = 0.0915 s y SD2 = 0.0911 s. Estos resultados indican que las variaciones a corto y largo plazo fueron muy parecidas durante el reposo. De igual forma, el índice CSI = 0.9959 muestra un equilibrio entre las componentes longitudinal y transversal del diagrama, mientras que el valor de CVI = -2.0792 evidencia una menor complejidad en la dinámica cardíaca, asociada a un estado fisiológico más estable y relajado.<br>
Por otro lado, en el segmento 2 correspondiente a la lectura en voz alta, se observa una mayor dispersión de los puntos y un aumento en la amplitud de la nube del diagrama de Poincaré. Los intervalos R-R muestran una variabilidad más amplia y aparecen puntos alejados de la distribución principal, indicando cambios más irregulares en la duración de los latidos consecutivos. Este comportamiento coincide con el incremento de las variaciones a corto y largo plazo, reflejado en los valores SD1 = 0.1617 s y SD2 = 0.1770 s. La elipse obtenida presenta un tamaño mayor respecto al segmento de reposo, mostrando un aumento en la variabilidad cardíaca durante esta condición. Asimismo, el índice CSI = 1.0945 indica un ligero incremento de la componente longitudinal respecto a la transversal, mientras que el CVI = -1.5433 presenta un valor menos negativo en comparación con el primer segmento, lo que sugiere una dinámica cardíaca más compleja y una mayor respuesta autonómica durante la actividad de lectura.<br>
Al comparar ambos segmentos, se evidencia que el primer periodo presenta una señal cardíaca más estable y menos dispersa, mientras que en el segundo segmento la variabilidad aumenta considerablemente. Este comportamiento también se observa en los parámetros cuantitativos, ya que tanto SD1 como SD2 incrementan en la condición de lectura, indicando mayores fluctuaciones instantáneas y globales en los intervalos R-R. Del mismo modo, el aumento del CSI y del CVI en el segundo segmento refleja una modificación en la regulación autonómica cardíaca, asociada a una mayor activación fisiológica durante la lectura en voz alta. En conjunto, los resultados obtenidos muestran cómo las diferentes condiciones experimentales influyen directamente sobre la variabilidad de la frecuencia cardíaca y sobre la respuesta del sistema nervioso autonomo.<br>
## Conclusiones 
Los resultados obtenidos permiten inferir que la señal de ECG evoluciona desde un estado inicial de estabilidad hacia un comportamiento progresivamente más variable y adaptable a lo largo del registro. Esta transición puede estar asociada a cambios fisiológicos propios del sujeto, así como a influencias respiratorias, cognitivas o de movimiento que afectan la regulación del sistema nervioso autónomo sobre el ritmo cardíaco.
La integración de diferentes etapas de análisis y preprocesamiento, tales como el filtrado de la señal, la segmentación temporal, el cálculo de medidas estadísticas (media y desviación estándar), los diagramas de Poincaré y los índices cuantitativos SD1, SD2, CSI y CVI, permite una caracterización más completa y detallada del comportamiento del ECG bajo distintas condiciones. Cada una de estas herramientas aporta información complementaria: el filtrado mejora la calidad de la señal al reducir el ruido, la segmentación facilita el análisis de la evolución temporal de la variabilidad, el diagrama de Poincaré permite una representación geométrica del comportamiento de los intervalos RR, y los índices derivados cuantifican de forma precisa la magnitud, distribución y complejidad de dicha variabilidad.<br>

Gracias a esta combinación metodológica, no solo es posible identificar cambios en la regulación autonómica del ritmo cardíaco, sino también interpretar la forma en que el organismo responde ante distintos estímulos o condiciones experimentales. En consecuencia, estos análisis resultan fundamentales para el estudio de la variabilidad de la frecuencia cardíaca, al permitir una comprensión integral del comportamiento dinámico del sistema cardiovascular desde una perspectiva temporal, estadística y geométrica.<br>
